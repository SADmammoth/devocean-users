...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      adapter: 'sails-mongo',
      url: 'mongodb://root:Vfrc200018root@testcluster-shard-00-00.kvuad.azure.mongodb.net:27017,testcluster-shard-00-01.kvuad.azure.mongodb.net:27017,testcluster-shard-00-02.kvuad.azure.mongodb.net:27017/devocean-users?ssl=true&replicaSet=TestCluster-shard-0&authSource=admin&retryWrites=true&w=majority',
      //--------------------------------------------------------------------------
   ...
   ***************************************************************************/
  custom: {
    baseUrl: 'https://devocean-users.herokuapp.com',
    jwtSecret: 'La31ePjAg_3oQm7b',
  },
